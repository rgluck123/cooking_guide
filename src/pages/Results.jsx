...
const Results = () => {
  ...
  const baseResults = [
    ...
    { id: '5', title: 'Lebanese Hummus & Pita', time: '15', protein: 'Vegetarian', difficulty: 'Beginner', cuisine: 'Lebanese', image: 'https://images.unsplash.com/photo-1574071318508-1cdbad80ad38?auto=format&fit=crop&w=800&q=80' },
    { id: '6', title: 'Lebanese Falafel Wrap', time: '30', protein: 'Vegetarian', difficulty: 'Intermediate', cuisine: 'Lebanese', image: 'https://images.unsplash.com/photo-1547050605-2f122ffad69a?auto=format&fit=crop&w=800&q=80' },
